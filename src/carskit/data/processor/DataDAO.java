...
public class DataDAO {
    ...
    public SparseMatrix readData(double binThold) throws Exception {
        ...
        while ((line = br.readLine()) != null) {
            ...
            //System.out.println(uic+"; "+cc+"; "+rate);
    ...
    public void printSpecs() throws Exception {
        ...
        sps.add(String.format("Data density: %.20f%%", (numRates + 0.0) / users / items / cdims * 100));
    ...
    public HashMap<Integer, HashMultimap<Integer, Integer>> getUserCtxList(SparseMatrix sm)
    {
        ...
        //System.out.println("getUserCtx train: ");
    ...
    public HashMap<Integer, HashMultimap<Integer, Integer>> getUserCtxList(SparseMatrix sm, HashMap<Integer, Integer> userUIMapper, HashMap<Integer, Integer> itemUIMapper)
    {
        HashMap<Integer, HashMultimap<Integer, Integer>> uciList=new HashMap<>();
        for(int uiid:sm.rows()){
            ...
            if(sv.getCount()>0){
                int[] ctx=sv.getIndex();
                for(int c:ctx){
                    int itemid = itemUIMapper.get(uiid);
                    if(uciList.containsKey(uid))
                    {
                        uciList.get(uid).put(c,itemid);
                    }else
    ...
    public HashMap<Integer, HashMultimap<Integer, Integer>> getUserCtxList(SparseMatrix sm, HashMap<Integer, Integer> userUIMapper, HashMap<Integer, Integer> itemUIMapper, double rateThreshold)
    {
        HashMap<Integer, HashMultimap<Integer, Integer>> uciList=new HashMap<>();
        for(int uiid:sm.rows()){
            int uid=userUIMapper.get(uiid);
    ...
    public Set<Integer> getItemList(SparseMatrix sm, HashMap<Integer, Integer> itemUIMapper)
    {
        Set<Integer> items=new HashSet<>();
        for(int uiid:sm.rows())
        {
            items.add(itemUIMapper.get(uiid));
        }
        return items;
    }
    ...
    public librec.data.SparseMatrix toTraditionalSparseMatrix(SparseMatrix sm, HashMap<Integer, Integer> userUIMapper, HashMap<Integer, Integer> itemUIMapper, BiMap<Integer,String> itemVirtualIds)
    {
        Table<Integer, Integer, Double> dataTable = HashBasedTable.create();
        Multimap<Integer, Integer> colMap = HashMultimap.create();
        ...
        return new librec.data.SparseMatrix(numUsers(), numItems()+itemVirtualIds.size(), dataTable, colMap);
    }

    public librec.data.SparseMatrix toTraditionalSparseMatrix(SparseMatrix sm, HashMap<Integer, Integer> userUIMapper, HashMap<Integer, Integer> itemUIMapper, int numVirtualItems)
    {
        Table<Integer, Integer, Double> dataTable = HashBasedTable.create();
        Multimap<Integer, Integer> colMap = HashMultimap.create();
        ...
        return new librec.data.SparseMatrix(numUsers(), numItems()+numVirtualItems, dataTable, colMap);
    }

    
    public librec.data.SparseMatrix toTraditionalSparseMatrix(SparseMatrix sm, HashMap<Integer, Integer> userUIMapper, HashMap<Integer, Integer> itemUIMapper, int numDaV, int whichDaV)
    {
        Table<Integer, Integer, Double> dataTable = HashBasedTable.create();
        Multimap<Integer, Integer> colMap = HashMultimap.create();
        ...
        if (whichDaV>0) {
        	if (whichDaV==1) //is DaVI approach
        		return new librec.data.SparseMatrix(numUsers(), numItems()+numDaV, dataTable, colMap);
        	else //is DaVU approach
        		return new librec.data.SparseMatrix(numUsers()+numDaV, numItems(), dataTable, colMap);
